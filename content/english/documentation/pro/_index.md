...
JobRunr Pro is a drop-in replacement for JobRunr, available under a [paid subscription]({{< ref "pro.md" >}}) and adds a lot of extra functionality to support your difficult business processes. 
