...
first_feature:
  ...
  list:
    ...
    - item: "Create dynamic queues to balance load or separate jobs for different tenants."
...
second_feature:
  ...
  sub_feature:
    - title: "Job Chaining"
      description: "Automatically trigger a new job only when a previous job or entire batch completes."
      icon: "fa-solid fa-link"
    - title: "Atomic Batches"
      description: "Group thousands of jobs into a single batch that succeeds or fails together."
...
third_feature:
  ...
  sub_feature:
    - title: "Multi-Cluster Dashboard"
      description: "Monitor all your JobRunr clusters, whether in the EU, US, or staging, from a single unified dashboard."
      icon: "fa-solid fa-globe"
    - title: "Runtime Rate Limiting"
